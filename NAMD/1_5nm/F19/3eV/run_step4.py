...
#case = 1   # 1.5 nm Si NC - H capped
case = 2   # 1.5 nm Si NC - F capped

if case == 1:
    trajs = range(10)
    params["data_set_paths"] = []
    for itraj in trajs:
        params["data_set_paths"].append( "/budgetdata/academic/alexeyak/brendan/Si_QD/H_capped/1_5nm/H1/step2/traj"+str(itraj)+"/res/" )
    if excess_eV == 1:
        params["istate"] = 14
    if excess_eV == 2:
        params["istate"] = 46
    ...
    params["data_set_paths"] = []
    for itraj in trajs:
        params["data_set_paths"].append( "/budgetdata/academic/alexeyak/brendan/Si_QD/F_capped/1_5nm/F19/step2/traj"+str(itraj)+"/res/" )
    if excess_eV == 1:
        params["istate"] = 11
    if excess_eV == 2:
        params["istate"] = 36
