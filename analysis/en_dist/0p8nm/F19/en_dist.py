...
params["data_set_paths"].append("/budgetdata/academic/alexeyak/brendan/Si_QD/F_capped/08nm/F19/step2/traj0/res/")
        ...
        for j in states:
            if j > i and j-i == 1:
                ...
                for de in dE:
                    ...
                    data_ij.append(x)
                bin_supp, dens, cum = data_stat.cmat_distrib(data_ij, 0, 0, 0, 0, 4, 0.001)
                dens_ij.append(dens)
